...
module.exports = async (client, interaction) => {
  if (!interaction.guild) {
    return interaction
      .reply({ content: "<:No:1330253494447243355> Command can only be executed in a discord server", ephemeral: true })
      .catch(() => {});
  }
  ...
  // Context Menu
    ...
    else return interaction.reply({ content: "<:No:1330253494447243355> An error has occurred", ephemeral: true }).catch(() => {});
  }
