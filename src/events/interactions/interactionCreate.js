...
module.exports = async (client, interaction) => {
  if (!interaction.guild) {
    return interaction
      .reply({ content: "<:no:1235502897215836160> Command can only be executed in a discord server", ephemeral: true })
      .catch(() => {});
  }
  ...
  // Context Menu
    ...
    else return interaction.reply({ content: "<:no:1235502897215836160> An error has occurred", ephemeral: true }).catch(() => {});
  }
