...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    if (targetChannel.length === 0) return message.safeReply(`<:No:1330253494447243355> No channels found matching " ${args[0]}" Make sure you input a valid channel ID or mention.`);
...
async function removeRR(guild, channel, messageId) {
  ...
  try {
    ...
    return "<:No:1330253494447243355> Oops! An unexpected error occurred. Try again later";
  }

  return "<:Yes:1330253737687781436> Done! Configuration updated";
}
