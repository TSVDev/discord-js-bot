...
module.exports = (client) => {
  const embed = new EmbedBuilder()
    ...
    .setDescription("<:Letter:1330257651904282634> Hey there! Thanks for considering to invite me\nUse the button below to navigate where you want");
  ...
  if (SUPPORT_SERVER) {
    components.push(new ButtonBuilder().setLabel("Space Labs").setURL(SUPPORT_SERVER).setStyle(ButtonStyle.Link));
  }
