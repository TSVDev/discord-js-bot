...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    //
    if (sub === "start") {
      if (!args[1]) return message.safeReply("<:Info:1330256387959164928> Incorrect usage! Please provide a channel to start the giveaway in");
    ...
    //
      ...
      const messageId = args[1];
      if (!messageId) return message.safeReply("<:Info:1330256387959164928> Incorrect usage! Please provide a message id");
  ...
  async interactionRun(interaction) {
    ...
    //
      ...
      if (!addDurationMs) {
        return interaction.followUp("<:Info:1330256387959164928> Not a valid duration");
      }
...
async function runModalSetup({ member, channel, guild }, targetCh) {
  ...
  if (!targetCh) return channel.safeSend("<:No:1330253494447243355> Giveaway setup has been cancelled. You did not mention a channel");
  ...
  if (isNaN(duration)) return modal.editReply("<:No:1330253494447243355> Setup has been cancelled. You did not specify a valid duration");
  ...
  if (isNaN(winners)) return modal.editReply("<:No:1330253494447243355> Setup has been cancelled. You did not specify a valid winner count");
  ...
  if (hostId) {
    try {
      ...
      return modal.editReply("<:No:1330253494447243355> Setup has been cancelled. You need to provide a valid userId for host");
    }
  }
...
async function runModalEdit(message, messageId) {
  ...
  if (isNaN(addDuration)) return modal.editReply("<:No:1330253494447243355> Update has been cancelled. You did not specify a valid add duration");
  ...
  if (isNaN(newWinnerCount)) {
    return modal.editReply("<:No:1330253494447243355> Update has been cancelled. You did not specify a valid winner count");
  }
