...
module.exports = async (member) => {
  ...
  if (giveaways.length === 0) {
    return "<:no:1235502897215836160> There are no giveaways running in this server.";
  }
  ...
  try {
    ...
    return `<:no:1235502897215836160> An error occurred while listing the giveaways: ${error.message}`;
  }
};
